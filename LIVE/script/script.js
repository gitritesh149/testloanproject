...
//         if (linkHref && linkHref !== "#" && linkHref !== "index.html" && currentPath.includes(linkHref)) {
...
//                     formResponseMsg.innerText = "Thank you! Your request was received cleanly. An advisor will contact you shortly.";
//                     contactForm.reset();
//                 } else {
//                     // Operational error block state context
//                     console.log(response);
//                     formResponseMsg.style.color = "#dc2626"; // Balanced standard red color hex
//                     formResponseMsg.innerText = serverOutput.message || "An operational interface timeout occurred. Please retry.";
//                 }
//             })
//             .catch((error) => {
...
//                 formResponseMsg.innerText = "Network transmission failed. Please confirm active internet connectivity and submit again.";
//             })
//             .finally(() => {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (currentPath === "/" || currentPath.endsWith("index.html")) {
        ...
        if (initialHash) {
            const hashLink = document.querySelector(`.nav-links a[href*="${initialHash}"]`);
            if (hashLink) {
    ...
    allNavLinks.forEach(link => {
        link.addEventListener("click", function (e) {
            ...
            if (hrefAttr && (hrefAttr.includes("#about") || hrefAttr.includes("#contact"))) {
